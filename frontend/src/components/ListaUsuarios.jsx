...
const ListaUsuario = () => {
  ...
  useEffect(() => {
    const getUsuarios = async () => {
      const res = await axios.get("https://proyecto-cliente-mern.onrender.com/api/usuarios");
      setLista(res.data);
    };
    getUsuarios();
  }, []);
  ...
  const eliminarUsario = async (id) => {
    await axios.delete(`https://proyecto-cliente-mern.onrender.com/api/usuarios/${id}`);
